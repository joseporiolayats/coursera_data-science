...
# Set up the plot space for 2x2 plots
par(mfrow=c(2,2))

# Plot top left with specified axis labels
plot(mydata$dateTime,mydata$Global_active_power,type="l",xaxt='n',ann=FALSE)
axis(1,at=c(min(mydata$dateTime),median(mydata$dateTime),max(mydata$dateTime)),labels=c("Thu","Fri","Sat"))
title(ylab="Global Active Power (kilowatts)")

# Plot top right with specified axis labels
plot(mydata$dateTime,mydata$Voltage,type="l",xaxt='n',ann=FALSE)
axis(1,at=c(min(mydata$dateTime),median(mydata$dateTime),max(mydata$dateTime)),labels=c("Thu","Fri","Sat"))
title(ylab="Voltage",xlab="datetime")

# Plot bottom left with specified axis labels
...
# Plot bottom right with specified axis labels
plot(mydata$dateTime,mydata$Global_reactive_power,type="l",xaxt='n',ann=FALSE)
axis(1,at=c(min(mydata$dateTime),median(mydata$dateTime),max(mydata$dateTime)),labels=c("Thu","Fri","Sat"))
